...
describe("parser", () => {
  it("should parse", async () => {
        ...
        <main className="flex min-h-screen flex-col items-center justify-between p-24">
          ...
          <div className="text-4xl">
            ...
            <div className="mt-4 flex items-center justify-center gap-4">
              ...
              <i className="i-[custom/tailwindcss] hover:text-cyan-400"></i>
            </div>
          </div>
    ...
    expect(classes.map((c) => c.value)).toEqual([
      ...
      "i-[twemoji/grinning-face] hover:i-[twemoji/flushed-face]",
      "text-sky-400 i-[twemoji/grinning-face] hover:i-[twemoji/grinning-face]/mask",
      "text-gray-600 i-[simple-icons/iconify] hover:text-sky-400",
      "flex",
      "i-[twemoji/grinning-face]",
      "i-[twemoji/sleeping-face]",
      "i-[custom/tailwindcss-icon]",
      "i-[custom/tailwindcss] hover:text-cyan-400",
